...
public interface SQLServerStatementVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLServerStatementParser#ifExist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfExist(SQLServerStatementParser.IfExistContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLServerStatementParser#basicPermission}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBasicPermission(SQLServerStatementParser.BasicPermissionContext ctx);
	/**
